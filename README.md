...
Приложение разработано на Next.js и показывает, как AI-ассистент может получать контекст интерфейса, фильтровать заявки, открывать нужную заявку и подготавливать изменение статуса с обязательным подтверждением пользователя.
